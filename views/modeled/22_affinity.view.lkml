...
view: user_order_product {
  derived_table: {
    ...
    sql: SELECT
      ...
      FROM @{bigquery_project}.@{bigquery_dataset}.order_items oi
      LEFT JOIN @{bigquery_project}.@{bigquery_dataset}.inventory_items ii
        ON oi.inventory_item_id = ii.id
      LEFT JOIN @{bigquery_project}.@{bigquery_dataset}. products p
...
view: total_order_product {
  derived_table: {
    ...
    sql: SELECT
        ...
        , COUNT(*) AS prod_freq
      FROM @{bigquery_project}.@{bigquery_dataset}.order_items oi
      LEFT JOIN @{bigquery_project}.@{bigquery_dataset}.inventory_items
