# The name of this view in Looker is "Atom Events"
view: atom_events {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `@{bigquery_project}.@{bigquery_dataset}.atom_events`
    ;;
  drill_fields: [id]
  ...
  # This dimension will be called "Ad Event ID" in Explore.
